        ...
        <Table size="small">
          <TableHead>
            <TableRow>
              ...
              <TableCell align="right">Free from</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {statistic &&
              sort(statistic.cars).map((row) => (
                <TableRow key={row.ad.id}>
                  <TableCell>
                    {row.ad.brandName + ` - ` + row.ad.modelName}
                  </TableCell>
                  ...
                  <TableCell align="right">
                    {`on ` + format(new Date(row.ad.freeFrom), "dd MMM yyyy")}
                  </TableCell>
                </TableRow>
              ))}
          </TableBody>
