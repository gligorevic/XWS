...
import AppBar from "../layouts/Navbar/MainNavbar";
...
const CartPage = ({
  ...
  const handleSubmitRequest = async (event, ad) => {
    ...
    cartItem[0]["userEmail"] = ad.car.userEmail;
  ...
  const handleAddToBundle = (e, ad) => {
    ...
    cartItem[0]["userEmail"] = ad.car.userEmail;
    cartItem[0]["userSentRequest"] = user.user.username;
    cartItem[0]["brandName"] = ad.car.brand.brandName;
    cartItem[0]["modelName"] = ad.car.model.modelName;

    setBundle((oldState) => [...oldState, cartItem[0]]);
    bundleRequest.userEmail = ad.car.userEmail;
  };
                      ...
                      <>
                        <ListItem>
                          <Grid container justify="space-around">
                            ...
                            <Grid item className={classes.listContainer} sm={2}>
                              <ListItemText primary={ad.car.userEmail} />
                            </Grid>
                            <Grid
                              item
                              style={{
